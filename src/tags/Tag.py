...
class FamilyTag(Tag):
    ...
    name = "family"
    # _replacements = _read_yaml("family_names.yaml")
...
class GivenTag(Tag):
    ...
    name = "given"
    # _replacements = _read_yaml("given_names.yaml")
...
class PrefixTag(Tag):
    ...
    name = "prefix"
    # _replacements = _read_yaml("name_prefixes.yaml")
...
class SuffixTag(Tag):
    ...
    name = "suffix"
    # _replacements = _read_yaml("name_suffixes.yaml")
...
class CityTag(Tag):
    ...
    name = "city"
    # _replacements = _read_yaml("city_names.yaml")
...
class CountyTag(Tag):
    ...
    name = "county"
    # _replacements = _read_yaml("county_names.yaml")
...
class StateTag(Tag):
    ...
    name = "state"
    # _replacements = _read_yaml("state_names.yaml")
...
class CountryTag(Tag):
    ...
    name = "country"
    # _replacements = _read_yaml("country_names.yaml")
